...
export default function ApprovedSignupsPage() {
  ...
  return (
    <Layout>
      <div className="space-y-6">
        ...
        {/* Title Section */}
        <div className="bg-gradient-to-r from-green-600 via-green-500 to-white rounded-xl shadow-2xl p-8">
          <h1 className="text-4xl font-bold mb-2 text-white drop-shadow-lg">
            Approved Events
          </h1>
          <p className="text-white text-lg font-semibold drop-shadow">
            Events you've been approved for
          </p>
        </div>

        {/* Events List */}
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-2 border-green-500/20">
          <div className="px-6 py-5 bg-gradient-to-r from-green-50 to-white border-b-2 border-green-500">
            <h2 className="text-2xl font-bold text-green-600">
              {approvedSignups.length} Approved {approvedSignups.length === 1 ? 'Event' : 'Events'}
            </h2>
          </div>
          ...
          <div className="p-6">
            {approvedSignups.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No approved events yet</h3>
                <p className="text-gray-600">Once a moderator approves your signups, they'll appear here!</p>
              </div>
            ) : (
